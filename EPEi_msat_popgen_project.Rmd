...
#setwd('~/Documents/Manuscripts/Gaos et al. Hawksbill genetic structure with Msats/EP_hawksbill_popgen_project')#change this accordingly
...
description <- "EiMSat_2017-02-03"
strata.file <- "Ei_strata_msats.csv"
genotypes.file <- "EP Ei genotypes_LK_strataG_input.csv"
...
table(Msat.Ei.geno.short$SITE)

Msat.Ei.geno.short<-Msat.Ei.geno.short[,7:57]#remove extra columns so first one is LabID
```

###Create a diploid gtypes object####
```{r gtypes, include=TRUE}
Msat.g <- new("gtypes", gen.data = Msat.Ei.geno.short[, -1], ploidy = 2,
                     ind.names = Msat.Ei.geno.short[, 1], schemes = strata.schemes, strata="SITE")
...
###Graphics: quick exploratory plots of some metrics that might be of interest
...
-Add more plots-combine here graphics from scripts I wrote for MMTD R 2016 workshop 
-Run STRUCTURE, etc. see other script, add in as needed here.