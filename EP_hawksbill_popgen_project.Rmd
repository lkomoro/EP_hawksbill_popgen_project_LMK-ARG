...
Msat.Ei.geno.short<-subset(Msat.Ei.geno.a,Country!="Panama")
Msat.Ei.geno.short<-subset(Msat.Ei.geno.short,Country!="Mexico")
...
Msat.g <- new("gtypes", gen.data = Msat.Ei.geno.short[, -1], ploidy = 2,
                     ind.names = Msat.Ei.geno.short[, 1], schemes = strata.schemes, strata="Country")
