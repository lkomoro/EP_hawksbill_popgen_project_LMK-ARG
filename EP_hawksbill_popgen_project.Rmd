...
strata <- "Country"  #name of stratum to use in analysis, not really using currently below, but could
...
### Test for all QA/QC tests: locus summaries, check for duplicates, etc.  
